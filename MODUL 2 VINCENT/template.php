...
if ($_POST){
    $tinggi_badan =$_POST["Tinggi Badan"];
    $berat_badan =$_POST["Berat Badan"];

    // case ketika gagal
    if($tinggi_badan == null || $berat_badan == null){
        $errMsg = "tinggi badan dan berat badan tidak boleh kosong"
    }
...
// silakan taruh code kalian di bawah
// if ($tinggi_badan == '' [[$tinggi_badan == '']]) ($berat_badan == '' [[$berat_badan == '']])(
//     $peasn_error "tinggi badan dan berat badan tidak boleh kosong "
